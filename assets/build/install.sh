...
GITLAB_CLONE_URL=https://git.coding.net/larryli/gitlab.git
...
exec_as_git git clone ${GITLAB_SHELL_CLONE_URL} ${GITLAB_SHELL_INSTALL_DIR}

cd ${GITLAB_SHELL_INSTALL_DIR}
exec_as_git git checkout  v${GITLAB_SHELL_VERSION}
...
exec_as_git git clone  ${GITLAB_WORKHORSE_CLONE_URL} ${GITLAB_WORKHORSE_INSTALL_DIR}
